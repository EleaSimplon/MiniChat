...
(function ( $ ) {
     $.fn.emojionePicker = function( options ) {
		 let emojiContainer = "emojionepicker",
		     activeEl;
		...
		let createContainer = function( el )
		{
			...
			$.each( emojiList,
				function( k, v )
				{
					let emoji = emojione.shortnameToImage( v["header"] );
			...
			$( document ).on( "click", "."  + emojiContainer +  " section .emojione",
				function()
				{		
					let caretPos = activeEl.selectionStart;
					let textAreaTxt = $( activeEl ).val();
					let txtToAdd;
		...
		let loadEmojies = function( section )
		{
		...
		{	
			...
			script.onload = function()
			{
				...
				$.each( $el, function( i, el ){
					let picker = $( '<div class="emojionepicker-picker" data-index="' + i + '"></div>' ).insertAfter( el );
				...
				$( ".emojionepicker-picker" ).click(
					function()
					{
						...
						let containerH = $( "."  + emojiContainer ).height();
						let containerW = $( "."  + emojiContainer ).width();
						let pickerOffset = $( this ).offset();
